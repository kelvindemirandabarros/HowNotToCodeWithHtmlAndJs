# Como não codificar com Html e JS / How Not To Code With Html And Js

Utilizando a biblioteca Axios para fazer requisições à [API de localidades do IBGE](https://servicodados.ibge.gov.br/api/docs/localidades?versao=1), esta página busca pelas cidades do estado selecionado e as coloca no respectivo select.
